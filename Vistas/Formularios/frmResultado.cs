...
namespace Vistas.Formularios
{
    public partial class frmResultado : Form
    {
        ...
        public frmResultado(string carnetBusqueda)
        {
            InitializeComponent();
            ...
            dgvEstudianteEncontrado.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string registroEliminar = dgvEstudianteEncontrado.CurrentRow.Cells[1].Value?.ToString();
                ...
                if (respuesta == DialogResult.Yes)
                {
                    if (es.EliminarEstudiante(id) == true)
                    {
        ...
        private void frmResultado_Click(object sender, EventArgs e)
        {
            txtBuscar.Text = "";
